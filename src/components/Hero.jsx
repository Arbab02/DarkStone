    ...
    >
      <div className="container mx-auto flex px-8 py-6 md:flex-row flex-col items-center">
        ...
        >
          ...
          <a href='/addTopic'><button className="block mx-auto lg:mx-0  xl:mx-0 md:mx-0 rounded-full text-xl bg-gradient-to-r from-indigo-700 via-indigo-800 to-indigo-900 font-normal mt-4 text-white px-7 py-3 shadow-lg hover:from-purple-600 hover:via-pink-600 hover:to-pink-600 transition duration-300">
  Join Our Courses
</button>
</a>
          </motion.p>
