  ...
  return (
    <section className="bg-[#050816] py-16">
      <div className="container mx-auto px-5">
        <h2 className="text-5xl font-bold mb-4 sm:mb-6 text-white text-center  leading-tight">Our Testimonials</h2>
        ...
        <Slider {...settings}>
          {testimonials.map((testimonial, index) => (
            <div key={index} className="p-4">
              <div className="bg-gradient-to-tr from-[#0A0E21] via-[#110E3C] to-[#0A0E21]  p-6 rounded-lg shadow-lg text-center">
